...
_RULES: list[tuple[Phase, list[str], float]] = [
    ...
    (
        ...
        [
            ...
            r"panic:",
            r"error:.*line \d+",
            r"fix\s+(this|the|my)\s+(bug|error|issue|crash)",
            r"why\s+(does|is|isn'?t|doesn'?t)",
            r"not\s+working",
            r"unexpected\s+(output|behavior|result)",
            r"exception\s+was\s+raised",
    ...
    (
        ...
        [
            ...
            r"test\s+case",
            r"mock",
            r"assert\s+.{0,30}(equal|raises|throws|true|false)",
            r"test\s+coverage",
        ],
        0.9,
    ),
    ...
    (
        ...
        [
            ...
            r"add\s+(doc|comment)",
            r"explain\s+(this|the)\s+(code|function|module)",
            r"api\s+doc",
            r"jsdoc",
            r"rustdoc",
            r"pydoc",
    ...
    (
        ...
        [
            ...
            r"search(ing)?",
            r"hash\s+map",
            r"graph\s+(traversal|algorithm|bfs|dfs)",
            r"optimal\s+(solution|approach)",
            r"tradeoff",
